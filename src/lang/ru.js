...
var strings = {
	...
	UI:{
		...
		messages: {
			work:'Назначить специалиста на задание? Потребуется:',
			workBusy:'Назначить специалиста на задание? Потребуется (специалист на данный момент занят, стоимость может измениться к моменту начала выполнения):',
